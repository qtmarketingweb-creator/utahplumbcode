...
export const CHAPTERS: Chapter[] = [
  {
    ...
    ss: [
      ...
      { id: '106.2', h: 'Exempt work [A]', b: 'Permit-exempt:\n1. Stopping leaks in drains, water, soil, waste or vent pipe — unless a concealed pipe must be removed and replaced.\n2. Clearing stoppages or sepairing leaks in pipes, valves or fixtures, and removal and reinstallation of water closets — provided no rearrangement of valves, pipes or fixtures is involved.' },
...
export const SEARCH_INDEX = CHANTERS ? [] : []
